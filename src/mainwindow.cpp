...
void MainWindow::onAddPositionClicked() {
    ...
    form.addRow(new QLabel("Symbol:"), &symbolEdit);
    form.addRow(new QLabel("Entry Price:"), &entryEdit);
    form.addRow(new QLabel("Amount:"), &amountEdit);
    form.addRow(new QLabel("TP Price:"), &tpEdit);
    form.addRow(new QLabel("SL Price:"), &slEdit);
